...
colors:
  ...
  bank-gsb: "#eb1985"
  asset-btc: "#f7931a"
  asset-btc-accent: "#ffab40"
  asset-eth: "#627eea"
  asset-eth-accent: "#8c9eff"
  asset-gold: "#e6a100"
  asset-gold-accent: "#ffd54f"
  asset-gold-deep: "#b27b00"
  asset-estate: "#8b5cf6"
  asset-estate-deep: "#6d28d9"
  canvas-tint: "#efe5e8"
  slate-muted: "#64748b"
  emerald-vivid: "#16a34a"
  purple-vivid: "#7c3aed"
  blue-vivid: "#2563eb"
  blue-standard: "#3b82f6"
  sky-vivid: "#0284c7"
  cyan-vivid: "#06b6d4"
  orange-vivid: "#ea580c"
