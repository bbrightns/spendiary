        ...
        <div className="flex items-center gap-2.5">
          ...
          {onStartGuide && (
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-semibold text-brand bg-brand/10 hover:bg-brand/20 active:scale-95 transition-all border border-brand/20 cursor-pointer shadow-xs"
            >
