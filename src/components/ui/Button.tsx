...
export function Button({
  ...
  const variants = {
    primary:
      'bg-ink text-white hover:bg-ink-hover dark:bg-brand dark:hover:bg-brand-ink shadow-[var(--shadow-soft)] active:scale-[0.98]',
    secondary:
    ...
    danger: 'bg-loss text-white hover:opacity-90 active:scale-[0.98]',
  }
  const sizes = {
