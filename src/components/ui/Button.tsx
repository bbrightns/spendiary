...
export function Button({
  ...
  const variants = {
    primary:
      'bg-ink text-white hover:bg-ink-hover dark:bg-brand dark:text-slate-950 dark:font-bold dark:hover:bg-brand-ink shadow-[var(--shadow-soft)] active:scale-[0.98]',
    secondary:
