      ...
      <div className="relative min-h-screen flex flex-col justify-between overflow-x-hidden font-sans select-none text-slate-900 bg-[#faf6f4]">
        ...
        <main className="relative z-10 w-full max-w-4xl mx-auto px-6 pt-2 pb-12 flex flex-col items-center">
          ...
          <h1 className="font-display font-black text-4xl sm:text-5xl md:text-6xl text-slate-950 text-center tracking-tight leading-[1.12] max-w-2xl mb-4">
            Spend smarter.{' '}
            <span className="block mt-1 sm:mt-2 text-[#0066FF] italic font-black">
              Now live wealthier.
            </span>
          </h1>

          {/* Subtitle */}
          <p className="text-slate-600 text-sm sm:text-base text-center max-w-xl leading-relaxed mb-10">
          ...
          {/* ── 3 Feature Cards (Fastwork 3-Column Style) ── */}
          ...
          {/* ── Sign In Action Box ── */}
          <div className="w-full max-w-md bg-white/95 backdrop-blur-xl rounded-[24px] border border-slate-200/90 shadow-[0_12px_40px_rgba(15,23,42,0.06)] p-7 sm:p-8">
